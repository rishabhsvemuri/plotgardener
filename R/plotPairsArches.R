...
#' @param x A numeric or unit object specifying pair arches plot x-location. Class: Positional.
...
#' @param width A numeric or unit object specifying pair arches plot width. Class: Positional.
#' @param height A numeric or unit object specifying pair arches plot height. Class: Positional.
