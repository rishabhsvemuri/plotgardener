...
#' )
#'
#' @param data A string path to .hic file as a string or a 3-column
...
#' the dataframe contains. Default value is \code{resolution = "auto"}. Options include: any numeric. 
#' @param zrange A numeric vector of length 2 specifying the
#' range of interaction scores to plot, where extreme values
#' will be set to the max or min. Default value is \code{zrange = NULL}. Options include: numeric vector of length 2.
...
#' @param x A numeric or unit object specifying triangle Hi-C plot x-location. Options include: any numeric.
...
#' width of the Hi-C plot triangle. Options include: any numeric.
#' @param height A numeric or unit object specifying the height of
#' the Hi-C plot triangle. Options include: any numeric.
#' @param just A string specifying the justification of triangle Hi-C plot relative to
