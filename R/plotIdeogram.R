...
#' )
#'
#' @param chrom A string specifying the chromosome to be plotted. Class: Data.
...
#' number of colors as there are gieStain values for each genome assembly. Class: Aesthetic.
#' @param x A numeric or unit object specifying ideogram x-location. Class: Positional.
...
#' @param width A numeric or unit object specifying ideogram width. Class: Positional.
#' @param height A numeric or unit object specifying ideogram height. Class: Positional.
