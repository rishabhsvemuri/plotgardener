...
#' )
#'
#' @param chrom A string representing the chromosome region to be plotted. Default value is \code{chrom = NULL}. Options = DNE.
#' @param chromstart An int start position on chromosome to be plotted. Default value is \code{chromstart = NULL}. Options = DNE.
#' @param chromend An int end position on chromosome to be plotted. Default value is \code{chromend = NULL}. Options = DNE.
...
#' @param x A numeric or unit object specifying genes plot x-location. Default value is \code{x = NULL}. Options = any numeric.
...
#' @param width A numeric or unit object specifying genes plot width. Default value is \code{width = NULL}. Options \code{any numeric}.
#' @param height A numeric or unit object specifying genes plot height. Default value is \code{height = NULL}. Options \code{any numeric}.
...
#' should be produced. Default value is \code{draw = TRUE}. Options = TRUE, FALSE.
